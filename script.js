...
const artigos = {
    ...
    artigo5: {
      titulo: "Manifesto do Homem que Rompeu as Muralhas",
      texto: `Eu sou um homem que acredita que o universo pode ser modificado a partir de dentro. Não falo de teorias, mas de experiência. Porque vivi, lutei e atravessei as fronteiras da própria limitação humana. Venho de uma cidade pequena, nascida entre colinas de simplicidade, onde os sonhos pareciam menores que as montanhas. Não havia mestres da consciência nem livros de sabedoria, mas havia um chamado silencioso — um pressentimento de destino. Saí sem mapa, apenas com a força de um propósito. Enfrentei o mundo grande, frio e indiferente. Conheci a zombaria, a solidão e o desprezo, mas nunca desisti daquilo que me movia: a certeza de que a vontade humana é capaz de dobrar a realidade. Com a coragem dos que não têm para onde voltar, transformei o medo em ferramenta, a dor em disciplina, a humilhação em energia de ascensão. Não aceitei o papel que me deram. Escolhi escrever o meu. Rompi muralhas, não apenas sociais, mas psíquicas, culturais, espirituais. Enfrentei o desconhecido e, ao enfrentá-lo, descobri que ele vivia dentro de mim. Estudei o invisível e o visível, a ciência e a alma, a psiquiatria e o espírito. Descobri que o homem adoece quando se desconecta de sua essência, e que o verdadeiro poder nasce quando o ego se curva diante da consciência. Hoje, não busco mais vencer o sistema — busco transcender a ilusão que o sustenta. A medicina que pratico é também um caminho de retorno: da mente ao coração, da dor à presença, da fragmentação à unidade. Sim, tornei-me doutor — mas não apenas de corpos e diagnósticos. Sou doutor das travessias invisíveis, das feridas da alma que pedem sentido, das consciências que desejam recordar quem são. E por isso afirmo: é possível modificar o universo existencial em nós. Porque o mundo externo é apenas o espelho da vibração interna. Mude o campo, e o campo muda tudo. Eu sou aquele que atravessou o abismo da dúvida, que suportou o peso da solidão, que viu a noite da alma e escolheu não morrer nela. Sou o homem que fez do sofrimento uma escola, e da vida, um laboratório de despertar. E se há algo que posso testemunhar com inteireza é isto: a consciência é a força mais revolucionária que existe. Quando um ser humano desperta, um novo mundo começa a se mover em silêncio.`,
      autor: "Wilfredo Finck Júnior"
    },
    artigo6: {
      titulo: "Manifesto do Médico da Consciência",
      texto: `Ser médico da consciência é reconhecer que a saúde não se limita à ausência de doença, mas expressa o grau de integração entre corpo, mente, emoção e alma. A prática médica, quando inspirada pela consciência, torna-se uma via de autoconhecimento e serviço. Cada encontro com um paciente é mais do que um ato clínico — é um encontro de campos vivos, onde o sofrimento humano pode revelar caminhos de transformação e sentido. O médico da consciência une a precisão da ciência à sabedoria da alma. Reconhece o valor das evidências, mas também o mistério que sustenta a vida. Sabe que curar não é apenas intervir, mas escutar, compreender e acompanhar o processo natural de reequilíbrio do ser. A mente é instrumento; a consciência, a origem. A biologia é expressão; o espírito, a intenção. E a verdadeira medicina nasce quando ambas se encontram em harmonia. O médico da consciência atua com ética vibracional, sabendo que cada palavra, gesto e presença são terapêuticos. Cuida para não adoecer junto, nem se distanciar demais — mantém o ponto de equilíbrio entre empatia e discernimento, entre compaixão e responsabilidade técnica. Sua missão é facilitar a reconexão do ser consigo mesmo, ajudar o paciente a recordar seu poder interno de cura, a compreender sua dor não apenas como falha, mas como processo de evolução e expansão da consciência. A medicina da consciência não nega o sofrimento, mas o ressignifica — como oportunidade de despertar, amadurecer e amar mais profundamente. Ser médico da consciência é estar a serviço da vida, em todas as suas formas e frequências. É ver a humanidade como um organismo em cura e cada paciente, como um universo em expansão.`,
      autor: "Wilfredo Finck Júnior"
    }
  };
